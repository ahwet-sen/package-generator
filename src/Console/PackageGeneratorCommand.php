...
class PackageGeneratorCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'package:generator {vendor=ahwet-sen} {package=package-name} {author=Ahwet Şen} {email=ahwt93sn@gmail.com} {description=package-name description.}';
     ...
     * @var string
     */
    protected $description = 'Generate a package from ahwet-sen/package-generator repository';
